                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                            ...
                            <div class="row">
                                <div class="col-sm-8 form-group">
                                    ...
                                    <input type="text" name="product_name" class="form-control"
                                        value="{{ $product->product_name ?? old('product_name') }}" placeholder="Enter name">
                                    @error('product_name')
                                ...
                                <div class="col-md-4 form-group">
                                    <div class="">
                                        ...
                                        <select class="form-control select2" name="category_id"
                                            value="{{ $product->category_id ?? old('category_id') }}" style="width: 100%;">
                                            <option selected="selected" disabled>Select category</option>
                                            @foreach ($categories as $item)
                                                <option {{ ($product->category_id ==$item->id) ? 'selected' : null}} value="{{ $item->id }}">{{ $item->category_name }}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="stock_on_hand" class="form-control"
                                        value="{{ $product->stock_on_hand ?? old('stock_on_hand') }}" placeholder="Enter Product code">
                                    @error('stock_on_hand')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="compare_price" class="form-control"
                                        value="{{ $product->compare_price ?? old('compare_price') }}" id="exampleInputPassword1">
                                    @error('compare_price')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="selling_price" class="form-control"
                                        value="{{ $product->selling_price ?? old('selling_price') }}" placeholder="Enter selling price">
                                    @error('selling_price')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="supplier" class="form-control"
                                        value="{{ $product->supplier ?? old('supplier') }}" placeholder="Enter Full name">
                                    @error('supplier')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="buying_price" class="form-control"
                                        value="{{ $product->buying_price ?? old('buying_price') }}" id="exampleInputPassword1">
                                    @error('buying_price')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="date" name="buying_date" class="form-control"
                                        value="{{ $product->buying_date ?? old('buying_date') }}" placeholder="Enter Product code">
                                    @error('buying_date')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="weight" class="form-control"
                                        value="{{ $product->weight ?? old('weight') }}" placeholder="Enter Product code">
                                    @error('weight')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="weightUnit" class="form-control"
                                        value="{{ $product->weightUnit ?? old('weightUnit') }}" placeholder="Enter Product code">
                                    @error('weightUnit')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 form-check col-sm-2 pt-5">
                                    <input type="checkbox" class="form-check-input" id="status" name="status"
                                        value="1" {{ $product->status ?? old('status') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3 col-sm-12">
                            ...
                            <textarea id="tags" name="tags" class="form-control" rows="3">{{ $product->tags ?? old('tags') }}</textarea>
                        </div>
